...
public class Sending_Mail_html {
	...
	public static void main(String message1) {
		...
		// String password = "fopuapjtkangtcpj";//mail and MAC
		// String password ="woawuffhvcdmyyvb"; //Others and JAVA
		...
		String subject = "Postman API Read Parameter Request," + LocalDateTime.now() + "";
